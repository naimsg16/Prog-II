...
class BoardTest10x8 {
    ...
    private final Board board = new Board(10, 8, BOARD);

    private final Position outOfBounds = new Position(4, 11);
    private final Position forbidden = new Position(0, 2);
    private final Position white = new Position(8, 5);
    private final Position black = new Position(8, 1);
    private final Position empty = new Position(9, 4);

    @Test
    void counters() {
        assertEquals(15, board.getNumBlacks());
        assertEquals(15, board.getNumWhites());
    }
    @Test
    void is_forbidden() {
